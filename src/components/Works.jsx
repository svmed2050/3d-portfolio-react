				...
				<div className='relative w-full h-[230px]'>
					...
					<div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
						...
						<div
							...
							className=' w-12 h-12 rounded-full flex justify-center items-center cursor-pointer ml-1'
						>
							<img
								src={demo}
								alt='demo'
		...
		<>
			...
			<div className='w-full flex'>
				...
				>
					...
					link to code repositories and live demos in it. It reflects my ability
